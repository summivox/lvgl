...
LV_ATTRIBUTE_FAST_MEM static inline lv_color_t lv_color_mix(lv_color_t c1, lv_color_t c2, uint8_t mix)
{
    ...
    mix = ( mix + 4 ) >> 3;
    uint32_t bg = (c2.full | (c2.full << 16)) & 0b00000111111000001111100000011111;
    uint32_t fg = (c1.full | (c1.full << 16)) & 0b00000111111000001111100000011111;
    uint32_t result = ((((fg - bg) * mix) >> 5) + bg) & 0b00000111111000001111100000011111;
